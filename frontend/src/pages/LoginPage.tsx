          ...
          <div className="p-8 md:p-12">
            ...
            {activeTab === 'login' && (
              <form onSubmit={handleLogin} className="space-y-5">
                ...
                <button
                  type="button"
                  className="w-full py-3 bg-slate-800 hover:bg-slate-700 border border-slate-600 text-white font-semibold rounded-lg transition-all flex items-center justify-center gap-2 uppercase tracking-wider"
                >
